...
[Version 0.0.10] - Added ignore version.
...
$functionsPath = Join-Path -Path (Split-Path -Parent $MyInvocation.MyCommand.Definition) -ChildPath 'functions.ps1'
Write-Debug "Importing functions from: $functionsPath"
. $functionsPath

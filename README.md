...
> [!NOTE]
> In this repository, [UpdateAll.ps1](./blob/main/UpdateAll.ps1) is a symbolic link to the [actual script](Chocolatey-Package-Updater/blob/main/Chocolatey-Package-Updater.ps1) in the Chocolatey Package Updater repository.

...
$packageArgs = @{
	...
	url            = "https://ftp.hp.com/pub/softlib/software13/printers/UPD/upd-ps-win10-x64-${version}.zip"
    checksum       = '26B228E9035FF93FBEF9C2F7272389B7AFD5F7299EFBB6E73956D2F225D62A29'
